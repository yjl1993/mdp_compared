...
func ComparedCQ1(addr1, addr2, addr3 string, port,worker int, dbname,
	...
	if match1To2 == false {
		Compared1(addr1, addr2, port, worker, dbname, msname, groupbytime, isEmpty2, cqcount1, cqcount2)
	...
	if match1To3 == false {
		Compared1(addr1, addr3, port, worker, dbname, msname,groupbytime, isEmpty3, cqcount1, cqcount3)
...
func Compared1(addr1, addr2 string, port, worker int, dbname, msname, groupbytime string,
	isemptyB bool, cqcountlistA, cqcountlistB [][]interface{}) {
